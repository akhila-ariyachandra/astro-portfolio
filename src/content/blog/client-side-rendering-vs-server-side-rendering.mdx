...
<PostImage
  src={import(
    "@/assets/blog/client-side-rendering-vs-server-side-rendering/csr.png"
  )}
  alt="Client Side Rendering diagram"
  credit={{
    name: "Alex Grigoryan",
...
<PostImage
  src={import(
    "@/assets/blog/client-side-rendering-vs-server-side-rendering/ssr.png"
  )}
