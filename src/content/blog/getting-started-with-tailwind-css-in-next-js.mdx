...
<PostImage
  src={import(
    "@/assets/blog/getting-started-with-tailwind-css-in-next-js/next_app.png"
  )}
  alt="Next.js Project"
/>
...
<PostImage
  src={import(
    "@/assets/blog/getting-started-with-tailwind-css-in-next-js/tailwind_size.png"
  )}
...
<PostImage
  src={import(
    "@/assets/blog/getting-started-with-tailwind-css-in-next-js/title_change.png"
  )}
  alt="Title styling"
/>
...
<PostImage
  src={import(
    "@/assets/blog/getting-started-with-tailwind-css-in-next-js/layout_change.png"
  )}
  alt="Layout styling"
/>
