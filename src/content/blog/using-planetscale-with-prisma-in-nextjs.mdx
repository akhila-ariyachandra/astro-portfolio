...
<PostImage
  src={import(
    "@/assets/blog/using-planetscale-with-prisma-in-nextjs/deploy-request-1.png"
  )}
...
<PostImage
  src={import(
    "@/assets/blog/using-planetscale-with-prisma-in-nextjs/deploy-request-2.png"
  )}
  alt="Deploy request"
/>
...
<PostImage
  src={import(
    "@/assets/blog/using-planetscale-with-prisma-in-nextjs/deploy-request-3.png"
  )}
...
<PostImage
  src={import(
    "@/assets/blog/using-planetscale-with-prisma-in-nextjs/deploy-vercel-1.png"
  )}
  alt="Connect button"
/>
...
<PostImage
  src={import(
    "@/assets/blog/using-planetscale-with-prisma-in-nextjs/deploy-vercel-2.png"
  )}
  alt="Database URL"
/>
